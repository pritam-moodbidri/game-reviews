...
public class GamespotReview implements Serializable {
	String gameTitle;
	String genre;
	Date releaseDate;
	Double scorePS3;
	...
	public Double getScoreMAC() {
		return scoreMAC;
	}
	
	public void setScoreMAC(Double scoreMAC) {
		this.scoreMAC = scoreMAC;
	}
	...
	public Double getScoreANDROID() {
		return scoreANDROID;
	}
	
	public void setScoreANDROID(Double scoreANDROID) {
